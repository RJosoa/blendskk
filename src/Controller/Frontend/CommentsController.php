...
final class CommentsController extends AbstractController{
    ...
    {
        return $this->render('frontend/comments/index.html.twig', [
    ...
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('frontend/comments/new.html.twig', [
            'comment' => $comment,
            'form' => $form,
        ]);
    }
    ...
    {
        return $this->render('frontend/comments/show.html.twig', [
            'comment' => $comment,
        ]);
    }
    ...
    public function edit(Request $request, Comments $comment, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('frontend/comments/edit.html.twig', [
            'comment' => $comment,
            'form' => $form,
        ]);
    }
